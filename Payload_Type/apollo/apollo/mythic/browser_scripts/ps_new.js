function(task, responses){
    if(task.status.includes("error")){
        ...
        let headers = [
            ...
            {"plaintext": "integrity_level", "type": "number", "cellStyle": {}, "width": 100},
        ...
        for(let i = 0; i < responses.length; i++)
        {
            ...
            const integrityLevelsMap = {10: 'Unknown', 0: 'Untrusted', 1:'Low', 2:'Medium', 3:'High', 4:'System', 5:'Protected'};
            ...
            {"plaintext": "info", "type": "button", "cellStyle": {}, "width": 6},
                    */
                    ...
                    "integrity_level": {"plaintext": integrityLevelsMap[pinfo["integrity_level"]], "cellStyle": {}},
